  ...
  <div>
    ...
    <div class="main">
      <div class="info">
        ...
        <div class="image">
          <img src="@/assets/account_header_01.png" />
        </div>
      </div>
      ...
      <div class="userAccount">
        <el-form :model="tempUser" label-width="80px">
          ...
          <el-form-item label="账号">
            <el-input v-model="tempUser.email" disabled></el-input>
          </el-form-item>
...
export default {
  ...
  created() {
    ...
    this.uploadAction = 'http://localhost:8080/staticResource/imgPost/' + this.tempUser.username
  },
  methods: {
    ...
    submit() {
      this.$axios.put('http://localhost:8080/user', this.tempUser)
      .then((res) => {
        var r = res.data;
        if (r.type == 'success') {
